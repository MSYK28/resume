  ...
  <!DOCTYPE html>
	...
	* {
	...
	htmlTemplate += `
			...
			<div class="rela-block caps greyed m-3">Profile</div>`;
	...
	htmlTemplate += `<div class="rela-block caps greyed m-3">Education</div>`;
	...
	htmlTemplate += `<div class="rela-block caps greyed m-3">Experience</div>`;
	...
	htmlTemplate += `<div class="rela-block caps greyed m-3">Projects</div>`;
